...
pub struct Config {
  ...
  // Hooks
  pub hook_pause: Option<String>,
  pub hook_resume: Option<String>,
  pub hook_resume_short_break: Option<String>,
  pub hook_pause_short_break: Option<String>,
  pub hook_resume_work: Option<String>,
  pub hook_pause_work: Option<String>,
  pub hook_pause_long_break: Option<String>,
  pub hook_resume_long_break: Option<String>,
  pub hook_start_short_break: Option<String>,
  pub hook_start_long_break: Option<String>,
  pub hook_start_work: Option<String>,
}
...
impl Default for Config {
  fn default() -> Self {
    ...
    Self {
      ...
      tui_show_stats: true,
      font: Fonts::Terminus,
      hook_pause_short_break: None,
      hook_resume_short_break: None,
      hook_pause_work: None,
      hook_resume_work: None,
      hook_pause_long_break: None,
      hook_resume_long_break: None,
      hook_start_short_break: None,
      hook_start_long_break: None,
      hook_start_work: None,
      hook_pause: None,
      hook_resume: None,
    }
  }
